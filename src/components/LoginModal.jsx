  ...
  const RenderRegister = () => {
    return <View style={styles.card}>
        <View style={styles.inputsContainerRegister}>
          ...
          <TextInput style={styles.inputStyleRegister}
    ...
    <Modal visible={props.isVisible} animationType="slide" transparent={true}>
      <View style={styles.modalBackground}>
        <View style={styles.tabsContainer}>
          <TouchableOpacity style={[styles.loginTabContainer, isLogin ? {backgroundColor: "white"} : {backgroundColor: "#ffffffAA"}]}
             onPress={() => setIsLogin(true)}>
            <Text>Inicio de sesion</Text>
          </TouchableOpacity>
          <TouchableOpacity style={[styles.registerTabContainer, !isLogin ? {backgroundColor: "white"} : {backgroundColor: "#ffffffAA"}]}
